...
while True:
	...
	imgPts = np.float32([[frame_w/2 - top_width, 20], [frame_w/2 + top_width, 20], [0, frame_h], [frame_w, frame_h]])

	# Select four points in an array for the destination video (the one you want to see as your output)
	objPoints = np.float32([[220, 0], [420, 0], [220, frame_h - top_crop/2], [420, frame_h - top_crop/2]])
